...
export default function OpportunityCard({ opportunity, isFeatured = false }) {
  ...
  return (
    ...
    >
      {/* Top ambient glow for featured cards */}
      {isFeatured && (
        <div
          style={{
            position: "absolute",
      ...
      <div>
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: "0.75rem", marginBottom: "1rem" }}>
            ...
            <div>
              <div style={{ display: "flex", alignItems: "center", gap: "0.35rem" }}>
                ...
                {opportunity.issuer.verified && (
                  <span title="Institución verificada por Punto Nexus">
          ...
          >
            <Bookmark size={17} fill={isFav ? "#fbbf24" : "none"} />
          </button>
        </div>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: "0.4rem", marginBottom: "1rem" }}>
          ...
          {opportunity.location && (
            <span className="badge-pill-tag" style={{ color: "var(--text-muted)" }}>
        ...
        <div style={{ borderTop: "1px solid rgba(255, 255, 255, 0.06)", paddingTop: "0.75rem", marginBottom: "1rem" }}>
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "0.35rem" }}>
            {previewRequirements.map((req, idx) => (
              <li key={idx} style={{ display: "flex", alignItems: "flex-start", gap: "0.45rem", fontSize: "0.825rem", color: "var(--text-muted)", lineHeight: 1.35 }}>
